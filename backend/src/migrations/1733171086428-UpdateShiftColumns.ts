...
export class UpdateShiftColumns1733171086428 implements MigrationInterface {
    name = 'UpdateShiftColumns1733171086428'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "shifts"`);
        await queryRunner.query(`ALTER TABLE "temporary_shifts" RENAME TO "shifts"`);
        await queryRunner.query(`CREATE TABLE "temporary_shifts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "workerId" integer, "shiftType" varchar CHECK( "shiftType" IN ('NORMAL_WORKDAY','WEEKEND_DAY','HOLIDAY','SICK_LEAVE','VACATION','UNPAID_LEAVE') ) NOT NULL DEFAULT ('NORMAL_WORKDAY'), "startTime" text NOT NULL, "endTime" text NOT NULL, "hoursWorked" float NOT NULL DEFAULT (0), "createdAt" text NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" text NOT NULL DEFAULT (CURRENT_TIMESTAMP))`);
        await queryRunner.query(`INSERT INTO "temporary_shifts"("id", "workerId", "shiftType", "startTime", "endTime", "hoursWorked", "createdAt", "updatedAt") SELECT "id", "workerId", "shiftType", "startTime", "endTime", "hoursWorked", "createdAt", "updatedAt" FROM "shifts"`);
        await queryRunner.query(`DROP TABLE "shifts"`);
        await queryRunner.query(`ALTER TABLE "temporary_shifts" RENAME TO "shifts"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_shifts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "workerId" integer, "shiftType" varchar CHECK( "shiftType" IN ('NORMAL_WORKDAY','WEEKEND_DAY','HOLIDAY','SICK_LEAVE','VACATION','UNPAID_LEAVE') ) NOT NULL DEFAULT ('NORMAL_WORKDAY'), "startTime" text NOT NULL, "endTime" text NOT NULL, "hoursWorked" float NOT NULL DEFAULT (0), "createdAt" text NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updatedAt" text NOT NULL DEFAULT (CURRENT_TIMESTAMP), CONSTRAINT "FK_e9992e51b7374929060284ed5df" FOREIGN KEY ("workerId") REFERENCES "worker" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_shifts"("id", "workerId", "shiftType", "startTime", "endTime", "hoursWorked", "createdAt", "updatedAt") SELECT "id", "workerId", "shiftType", "startTime", "endTime", "hoursWorked", "createdAt", "updatedAt" FROM "shifts"`);
        await queryRunner.query(`DROP TABLE "shifts"`);
        await queryRunner.query(`ALTER TABLE "temporary_shifts" RENAME TO "shifts"`);
